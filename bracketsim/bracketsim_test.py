...
east = tourney.loc[tourney.region == "east"]
east.name = "east"
west = tourney.loc[tourney.region == "west"]
west.name = "west"
south = tourney.loc[tourney.region == "south"]
south.name = "south"
midwest = tourney.loc[tourney.region == "midwest"]
